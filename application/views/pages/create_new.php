            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Router details</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            
							<?php echo form_open_multipart('Home/create','class="form-horizontal"','method="post"');?>
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">SAP ID</label>
                                            <input type="text" id="first-name-column" class="form-control required" required placeholder="" name="SAP_ID" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="Description">Hostname</label>
											<input type="text" name="hostname" class="form-control required" required>
                                        </div>
                                    </div>
									 <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="Description">Loop back</label>
											<input type="text" name="loopback" class="form-control required" onkeydown="check_name_availability();" required>
									 ...
									 <div class="col-md-12 col-12">
                                        <div class="form-group">
											...
											<input type="text" name="mac_address" class="form-control required" required>
                                        </div>
                                    </div>
									 <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="Description">IP Address</label>
											<input type="text" name="ip_address" class="form-control required ip_address" required>																						
                                        </div>
                                    </div>
									<div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label for="Description">Router type</label>
											<input type="text" name="router_type" class="form-control required" required>
                                        </div>
                                    </div>
									 <div class="col-md-12 col-12">
                                        <div class="form-group">
